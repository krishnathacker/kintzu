...
import {
  ArrowRight, Landmark, Scale, Users, Compass, Handshake, Heart,
  ChartLine, Rocket, Shield, Mail, Globe, CheckCircle2
} from "lucide-react";
...
const marketPie = [
  { name: "Counselling & Mentoring", value: 7000 },
...
const Pill = ({ children }) => (
  <span className="inline-flex items-center gap-2 rounded-2xl border border-amber-300/50 bg-amber-50 px-3 py-1 text-sm text-amber-800">
    {children}
  </span>
);
    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#FDFBF8_0%,#F8E6D3_100%)] text-slate-800">
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/60 border-b border-amber-200/40">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <a
            href="#contact"
            className="hidden md:inline-flex items-center gap-2 rounded-2xl bg-amber-400 hover:bg-amber-500 text-white px-4 py-2 text-sm transition"
          >
      ...
      <Section id="problem" title="The Crisis: Emotional Chaos, Structural Void" kicker="Context">
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <p>
              Every year, India’s family courts handle <strong>8.2 lakh cases</strong>.
              Fewer than <strong>10%</strong> access support before litigation.
            </p>
            ...
            <p className="mt-4">
              People must navigate life-changing choices alone — without maps or meaningful support.
            </p>
          </div>
      ...
      <Section id="market" title="The Market Void: A ₹12,000 Cr Category Awaiting a Brand" kicker="TAM • SAM • Beachhead">
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            <p>
              The "relationship-lifecycle economy" in India exceeds <strong>₹12,000 crore ($1B+)</strong>,
              but is fragmented and unbranded. Target: <strong>35M</strong> urban professionals (28–45 years) —
              educated, digitally native, and privacy-conscious. Kintzu is positioned to become India’s first trusted
              life transition brand.
            </p>
      ...
      <Section id="tailwinds" title="Macro Tailwinds: Culture Shifts Toward Clarity" kicker="Why now">
        <div className="grid md:grid-cols-2 gap-10">
          <div className="space-y-3">
            <p>
              Post-pandemic, India is shifting: Counselling usage doubled. Courts favor mediation.
              Corporates introduce “life event” benefits. Digital privacy laws (DPDP 2023) enable confidential B2C services.
            </p>
            <p>Consumers now expect calm, confidential, judgment-free digital help.</p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {["Counselling & mentoring ↑", "Mediation momentum", "Corporate benefits", "Privacy-first infra"].map((t, i) => (
      ...
      <Section id="stories" title="User Stories: From Conflict to Dignified Reorganization" kicker="Human outcomes">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="rounded-2xl border bg-white p-6">
            ...
            <p>
              “I didn’t know if I should stay or go. Kintzu’s Compass helped me find clarity — and my courage.”
              She used Compass, found clarity, and booked a counsellor. Within weeks she found emotional stability
          ...
          <div className="rounded-2xl border bg-white p-6">
            ...
            <p>
              “We’d decided to part but wanted peace, not pain.” He used Counsel for mediation and Circle for
              co-parenting. The process was organized, respectful, and child-centered.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section id="product" title="Product Experience: Built for Fragility" kicker="Designed for fragility">
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <p>
              Every pixel and word is designed to reduce overwhelm and increase agency. Anonymous onboarding,
              calm visuals (soft neutrals, high white space), human-in-the-loop, and privacy by design.
            </p>
          ...
          <div className="rounded-2xl border bg-white p-6">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="rounded-xl border p-3">RCI-licensed psychologists</div>
            </div>
          </div>
        </div>
      </Section>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>2) <strong>Marketplace</strong> (15% Take Rate): Counsel, counselling & mentoring, mediation.</li>
      ...
      <Section id="financials" title="3-Year Financials: Scale, Margin, & LTV" kicker="Revenue • Users • LTV/CAC">
        ...
        <div className="mt-8 grid sm:grid-cols-4 gap-4 text-sm">
          <div className="rounded-xl border bg-white p-4">
            <p className="text-slate-500">Revenue (Y3)</p><p className="text-xl font-semibold">₹7.5 Cr</p>
          </div>
          <div className="rounded-xl border bg-white p-4">
            <p className="text-slate-500">Paid Users (Y3)</p><p className="text-xl font-semibold">35,000</p>
          </div>
          <div className="rounded-xl border bg-white p-4">
            <p className="text-slate-500">Gross Margin</p><p className="text-xl font-semibold">78%</p>
          </div>
          <div className="rounded-xl border bg-white p-4">
            <p className="text-slate-500">Break-even</p><p className="text-xl font-semibold">Q4 Year 3</p>
          </div>
        </div>
      </Section>
      ...
      <Section id="roadmap" title="Traction Roadmap: Global Ambition" kicker="0–36 months">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border bg-white p-6">
            <p className="text-slate-500 text-sm mb-1">0–6 Months</p>
            <p>Launch Compass & Counsel; first corporate pilot.</p>
            <div className="mt-3 text-amber-700 text-sm inline-flex items-center gap-1">
              <CheckCircle2 size={16} /> KPI: 500 users
            </div>
          </div>
          <div className="rounded-2xl border bg-white p-6">
            <p className="text-slate-500 text-sm mb-1">6–12 Months</p>
            <p>Launch Circle & Dashboard; strengthen brand trust.</p>
            <div className="mt-3 text-amber-700 text-sm inline-flex items-center gap-1">
              <CheckCircle2 size={16} /> KPI: 10 corporate pilots
            </div>
          </div>
          <div className="rounded-2xl border bg-white p-6">
            <p className="text-slate-500 text-sm mb-1">Year 2–3</p>
            <p>10-city rollout; ₹5 Cr ARR; integrate financial rails; Global pilot (Singapore/UK NRIs).</p>
            <div className="mt-3 text-amber-700 text-sm inline-flex items-center gap-1">
              <CheckCircle2 size={16} /> KPI: Break-even Q4 Y3
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section id="ask" title="Funding Ask: ₹3–4 Cr Seed Round" kicker="Use of funds">
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            ...
            <p className="mt-3">
              Use of Funds (emphasize Trust & Growth): 35% Product & Tech, 25% Expert Network QA, 25% Marketing & Trust, 15% Ops & Compliance.
            </p>
            <p className="mt-3 font-medium">
              Call to Action: By investing in Kintzu, you’re shaping the category-defining platform for dignified decision-making in India.
            </p>
          </div>
      ...
      <Section id="vision" title="The Vision: “The Gold in Our Cracks”" kicker="Kintsugi">
        <p>
          Inspired by <em>Kintsugi</em>, Kintzu celebrates repair — not rupture. We believe every relationship —
          even when redefined — can be more beautiful through understanding. Every ending deserves a thoughtful beginning.
        </p>
      </Section>
      ...
      <Section id="summary" title="Summary Snapshot" kicker="One-page view">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border bg-white p-6">
            ...
            <p>
              Continuity is the moat. Kintzu orchestrates the full journey: Compass → Counsel → Circle → Dashboard —
              from reflection to reorganization.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section id="contact" title="Let’s build a world where clarity is a right, not a privilege" kicker="Contact">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border bg-white p-6 flex items-center gap-3">
            <Mail className="text-amber-600" />
            <div>
              <div className="text-sm text-slate-500">Email</div>
              <div className="font-medium">krishn@kintzu.com</div>
            </div>
          </div>
          <div className="rounded-2xl border bg-white p-6 flex items-center gap-3">
            <Globe className="text-amber-600" />
            <div>
              <div className="text-sm text-slate-500">Web</div>
              <div className="font-medium">www.kintzu.com</div>
            </div>
          </div>
          <div className="rounded-2xl border bg-white p-6 flex items-center gap-3">
        ...
        <div className="mt-10 flex items-center gap-3">
          <a
            href="#solution"
            className="inline-flex items-center gap-2 rounded-2xl bg-amber-400 hover:bg-amber-500 text-white px-5 py-3 transition"
          >
            See the solution <ArrowRight size={16} />
          </a>
          <a
            href="#financials"
            className="inline-flex items-center gap-2 rounded-2xl border border-slate-300 bg-white hover:bg-slate-50 transition px-5 py-3"
          >
            See financials <ChartLine size={16} />
          </a>
        </div>
      </Section>
